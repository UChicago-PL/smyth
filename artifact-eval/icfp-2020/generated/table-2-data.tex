...
list\_drop&5 (45\%)&5 (45\%)&\highlightRed{$\bullet$}&(6,9)$^{}$&\highlightBlue{(6,10)$^{}$}&\highlightRed{$\bullet$}\\ 
...
list\_last&4 (67\%)&4 (67\%)&\highlightRed{$\bullet$}&(5,12)$^{}$&\highlightBlue{(6,10)$^{}$}&\highlightRed{$\bullet$}\\ 
...
list\_nth&5 (38\%)&5 (38\%)&\highlightRed{$\bullet$}&(8,15)$^{}$&\highlightBlue{(8,16)$^{}$}&\highlightRed{$\bullet$}\\ 
...
list\_stutter&2 (67\%)&2 (67\%)&\highlightRed{$\bullet$}&(3,3)$^{}$&\highlightBlue{(2,4)$^{}$}&\highlightRed{$\bullet$}\\ 
list\_sum&2 (67\%)&2 (67\%)&\highlightRed{$\bullet$}&(2,3)$^{}$&\highlightBlue{(2,2)$^{}$}&\highlightRed{$\bullet$}\\ 
list\_take&6 (50\%)&\highlightBlue{5 (42\%)}&\highlightRed{$\bullet$}&(7,10)$^{}$&\highlightBlue{(7,11)$^{}$}&\highlightRed{$\bullet$}\\ 
...
nat\_max&9 (100\%)&9 (100\%)&\highlightRed{$\bullet$}&(9,11)$^{}$&\highlightBlue{(8,11)$^{}$}&\highlightRed{$\bullet$}\\ 
...
tree\_count\_nodes&3 (50\%)&3 (50\%)&\highlightRed{$\bullet$}&(4,$\downarrow$)$^{10}$&\highlightBlue{(4,16)$^{}$}&\highlightRed{$\bullet$}\\ 
